...
bool CProjectile2D::Init(void)
{
	...
	Left = CImageLoader::GetInstance()->LoadTextureGetID("Image/Scene2D_ArrowLeft.tga", true);
	Right = CImageLoader::GetInstance()->LoadTextureGetID("Image/Scene2D_ArrowRight.tga", true);
	if (Left == 0 || Right == 0)
	{
...
void CProjectile2D::SpawnProjectile(bool DirectionL, glm::vec2 position) {
	isLeft = DirectionL;
	vec2Index = position;
}
