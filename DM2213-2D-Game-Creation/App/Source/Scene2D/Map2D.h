...
public:
	...
	bool Init(	const unsigned int uiNumLevels = 1,
				...
				const unsigned int uiNumCols = 36);
...
protected:
	...
	glm::vec2 m_startPos; glm::vec2 m_targetPos;

	std::priority_queue<Grid> m_openList; std::vector<bool> m_closedList; std::vector<Grid> m_cameFromList;
	//std::vector<int> m_grid;
	std::vector<glm::vec2> m_directions; HeuristicFunction m_heuristic;
};