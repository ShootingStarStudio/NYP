 ...
 */
CMeshRenderer::CMeshRenderer(	const glm::vec3 vec3Position,
 ...
 */
bool CMeshRenderer::LoadModelAndTexture(const char* filenameModel,
 ...
 */
void CMeshRenderer::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CMeshRenderer::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CMeshRenderer::SetProjection(const glm::mat4 projection)
{
...
/**
 ...
 @return A bool variable
 */
bool CMeshRenderer::Update(const double dElapsedTime)
{
 ...
 */
void CMeshRenderer::PreRender(void)
{
...
*/
void CMeshRenderer::PostRender(void)
{
...
/**
 @brief Print Self
 */
void CMeshRenderer::PrintSelf(void)
{
	cout << "CMeshRenderer::PrintSelf()" << endl;
	cout << "========================" << endl;
}
