...
public:
    ...
    glm::vec3 vec3Position, vec3PositionOffset;
    glm::vec3 vec3Front, vec3FrontOffset;
    glm::vec3 vec3Up, vec3UpOffset;
    glm::vec3 vec3Right, vec3RightOffset;
	// Euler Angles
    float fYaw, fYawOffset;
    float fPitch, fPitchOffset;
	float fRoll, fRollOffset;
    // Camera options
