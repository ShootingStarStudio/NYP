...
public:
	...
	virtual float GetPitchRecoil(void) const;
	virtual float GetYawRecoil(void) const;
	...
	virtual float GetScopeMultiplier(void);

	virtual void ApplyRecoil(void);
...
protected:
	...
	// The amount of recoil per shot
	float fPitchRecoil, fYawRecoil;

	// the amount of damage per bullet
	int iDamage;
