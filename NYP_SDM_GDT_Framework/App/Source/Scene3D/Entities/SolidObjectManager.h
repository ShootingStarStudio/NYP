/**
 CSolidObjectManager: This class manages and updates all the CSolidObjects in the 3D environment
 By: Toh Da Jun
 Date: Sept 2021
 */
...
public:
	...
	//glm::vec2 intersectAABB(glm::vec3 rayOrigin, glm::vec3 rayDir, glm::vec3 vec3BoxMin, glm::vec3 vec3BoxMax);
