...
public:
	...
	// Init
	virtual bool Init(glm::vec3 vec3TopRight, glm::vec3 vec3BottomLeft);
	// Init
	virtual bool Init(glm::vec3 vec3TopRight, glm::vec3 vec3BottomLeft, float fTopLeftHeight, float fBottomRightHeight);
