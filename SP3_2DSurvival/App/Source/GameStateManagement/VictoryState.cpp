 ...
 */
bool CVictoryState::Init(void)
{
	//cout << "CVictoryState::Init()\n" << endl;
	//CShaderManager::GetInstance()->Use("Shader2D");
	////CShaderManager::GetInstance()->activeShader->setInt("texture1", 0);

	//Create Background Entity
	background = new CBackgroundEntity("Image/VictoryBackground.png");
 ...
 */
bool CVictoryState::Update(const double dElapsedTime)
{
	...
	if (CKeyboardController::GetInstance()->IsKeyReleased(GLFW_KEY_ESCAPE))
	{
		...
		// Load the menu state
		cout << "Quitting the game from VictoryState" << endl;
		return false;
	}
...
void CVictoryState::Render(void)
{
	...
	//cout << "CVictoryState::Render()\n" << endl;
}

/**
 @brief Destroy this class instance
 */
void CVictoryState::Destroy(void)
{
	// Disable the cursor
	if (CSettings::GetInstance()->bDisableMousePointer == true)
