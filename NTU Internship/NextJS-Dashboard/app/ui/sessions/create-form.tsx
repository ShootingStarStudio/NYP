...
import { ParticipantField } from '@/app/lib/definitions';
...
export default function Form({ participants }: { participants: ParticipantField[] }) {
      ...
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <div id="participant-error" aria-live="polite" aria-atomic="true">
            {state.errors?.participantId && state.errors.participantId.map((error: string) => (
